<div>
    ...
    <nav class="w-full flex-shrink-0 bg-white border-t border-gray-200 shadow-lg flex justify-between items-center px-6 py-2 md:hidden">
        ...
        <a href="{{ route('wishlist.index') }}" class="flex flex-col items-center text-gray-500 hover:text-pink-600 transition">
            <i class="fas fa-heart text-xl"></i>
            <span class="text-xs">Favoris</span>
        </a>
        <a href="{{ route('user-reservations') }}" class="flex flex-col items-center text-gray-500 hover:text-blue-600 transition">
            <i class="fas fa-calendar-check text-xl"></i>
            <span class="text-xs">Réservations</span>
        </a>
        <a href="{{ route('user.menu') }}" class="flex flex-col items-center text-gray-500 hover:text-blue-600 transition">
            <i class="fas fa-user text-xl"></i>
            <span class="text-xs">Profil</span>
        </a>
    </nav>
    <footer class="bg-gray-900 w-full hidden md:block">
        <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            <!-- Grid -->
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                <div class="col-span-full lg:col-span-1">
                    <a class="flex-none text-xl font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">Afridayz</a>
                </div>
                <!-- End Col -->
            ...
            <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
                <div class="flex justify-between items-center">
                    <p class="text-sm text-gray-400">© 2025 Nackito. All rights reserved.</p>
                </div>
                <!-- End Col -->
