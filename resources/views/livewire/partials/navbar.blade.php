<div class="livewire-navbar-root">
    <header class="flex z-[9999] fixed inset-x-0 top-0 md:sticky md:top-0 flex-wrap md:justify-start md:flex-nowrap w-full bg-white md:bg-white text-sm py-3 md:py-0 dark:bg-gray-800 md:dark:bg-gray-800 shadow-sm" style="padding-top: env(safe-area-inset-top);">
        <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
            <div class="relative md:flex md:items-center md:justify-between">
                <div class="flex items-center justify-between">
                    <a class="flex items-center gap-2 flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/" aria-label="Brand">
                        <img src="/images/logo-afridayz.svg" alt="Afridayz logo" class="h-8 w-8 mr-2" loading="lazy">
                        Afridayz
                    </a>
                    <div class="md:hidden">
                        @guest
                ...
                <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                    <div class="max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
                        <div class="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                            ...
                            <!-- mobile privacy link removed (moved to Mon espace page) -->
                            ...
                            <div x-data="{ open: false }" class="relative inline-block text-left z-[9999]">
                                <button type="button"
                                ...
                                <div x-show="open" @click.outside="open = false" class="user-menu-dropdown-fixed md:block absolute right-0 mt-2 w-48 origin-top-right bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50"
                                    style="display: none;"
